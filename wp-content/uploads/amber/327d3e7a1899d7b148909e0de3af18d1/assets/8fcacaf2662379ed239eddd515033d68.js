...
YAHOO.util.Get = function() {
    ...
    return {
         ...
         * </dl>
         * <pre>
         *      YAHOO.util.Get.css("http://yui.yahooapis.com/2.7.0/build/menu/wp-content/skins/sam/menu.css");
         * </pre>
         * <pre>
         *      YAHOO.util.Get.css(["http://yui.yahooapis.com/2.7.0/build/menu/wp-content/skins/sam/menu.css",
         *                          "http://yui.yahooapis.com/2.7.0/build/logger/wp-content/skins/sam/logger.css"]);
         * </pre>
         * @return {tId: string} an object containing info about the transaction
         */
...
(function() {
    ...
    'root': VERSION + '/build/',
    'base': '//ajax.googleapis.com/ajax/libs/yui/' + VERSION + '/build/',
    'combine': false,

    // 'comboBase': '//yui.yahooapis.com/combo?', googleapis do not do combine
    ...
    YAHOO.util.YUILoader = function(o) {
         ...
         *      // http://yui.yahooapis.com/2.3.0/build/wp-content/skins/sam/
         *      base: 'assets/skins/',
         *
