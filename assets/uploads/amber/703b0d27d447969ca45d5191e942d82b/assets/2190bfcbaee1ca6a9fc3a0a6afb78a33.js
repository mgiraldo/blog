  ...
  $.fn.tweet = function(o){
    ...
    function build_url() {
      ...
      if (s.list) {
        ...
        return proto+'//api.twitter.com/1/statuses/user_timeline.json?screen_name='+s.username[0]+'&count=13&exclude_replies=1&include_rts=1&callback=?';
      } else {
